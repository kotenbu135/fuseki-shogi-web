...
const DICT = {
  ...
  status_ai_kings_sub: {
    ja: 'あなたは選ぶ役。置き終えたら、持ちたい玉を押す。',
    en: 'You are the chooser. When both kings are placed, tap the king you want.',
  },
  ...
  role_chip_placer: { ja: '置く役', en: 'placer' },
  role_chip_chooser: { ja: '選ぶ役', en: 'chooser' },
  kifu_head_took: { ja: '{who}が{side}を持つ', en: '{who} took {side}' },
