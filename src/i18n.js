...
const DICT = {
  ...
  opp_ai: { ja: 'AIと対局', en: 'Play the AI' },
  opp_ai_sub: { ja: 'ひとりで、すぐに', en: 'alone, right now' },
  opp_friend: { ja: '友達と対局', en: 'Play a friend' },
  opp_friend_sub: { ja: '招待リンクを送る', en: 'send a link' },
  opp_lobby: { ja: '待合で対局', en: 'Lobby' },
  opp_lobby_sub: { ja: '誰でも入れる募集', en: 'open to anyone' },
  ...
  btn_invite: { ja: '招待リンクを作る', en: 'Create invite link' },
  btn_invite_title: {
    ja: '部屋を作ってリンクを送る。相手が開くと始まる',
    en: 'Create a room and send the link. The game starts when your friend opens it',
  },
  opp_friend_note: {
    ja: 'リンクを開いた相手が入ると始まる。リンクを知らない人は入れない。',
    en: 'The game starts when your friend opens the link. Nobody else can get in.',
  },
  btn_seek: { ja: '待合に出す', en: 'Post to lobby' },
  opp_lobby_note: {
    ja: '誰でも入れる。招待リンクも出るので、友達に送ってもよい。',
    en: 'Anyone can join. You also get an invite link, so you can send it to a friend.',
  },
  ...
  // 段2: 待合と名前
  opt_nick: { ja: 'あなたの名前', en: 'Your name' },
  ...
  lobby_head: { ja: 'いま募集中', en: 'Open games' },
  lobby_empty: { ja: 'いま募集中の対局は無い。下で募集すると、ここに出る。', en: 'No open games right now. Post one below and it shows up here.' },
  lobby_seek_head: { ja: '自分で募集する', en: 'Post your own' },
