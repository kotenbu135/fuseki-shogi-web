...
const DICT = {
  ...
  kifu_head_you_placer: { ja: 'あなたが両玉を置き、AIが{choice}', en: 'You place both kings; the AI {choice}' },
  kifu_head_you_chooser: { ja: 'AIが両玉を置き、あなたが{choice}', en: 'The AI places both kings; you {choice}' },
