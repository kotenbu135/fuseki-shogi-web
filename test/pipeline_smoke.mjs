...
const MODEL = process.argv[4] || path.join(ROOT, 'models/fuseki_degct_b3_iter4.onnx');
...
if (!fs.existsSync(MODEL)) {
  console.error(`models/fuseki_degct_b3_iter4.onnx が無い。開発用リポジトリからコピーすること（models/README.md）。`);
  process.exit(1);
}
