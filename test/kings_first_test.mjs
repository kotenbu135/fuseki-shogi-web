// 両玉先置きモード（開発リポジトリ docs/rules.md「両玉先置きモード」）の状態機械を
...
function makeTable() {
  ...
  return new KingTable({ format: 'king_pair_table/1', model: 'iter64.npz', band: ['9i,1a', '1i,9a'], pairs });
}
...
check('世代がずれた表は落とす', () => {
  ...
  new KingTable(table.data, { modelFile: 'fuseki_degct_b3_iter64.onnx' });
});
